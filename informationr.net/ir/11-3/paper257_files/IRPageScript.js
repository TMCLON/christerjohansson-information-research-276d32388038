	...
	newWindow.document.write('<link rel="stylesheet" type="text/css" href="p257files/IRPrintStyle.css" media="print"/></head>');
	...
	function goHome()
	{
	 window.location.href = "http://informationr.net/ir/";
	}
	...
	function handleFont()
	{
		...
		if (flag)
		{
		 ...
		 {
		 htmlDoc[i].style.fontFamily = "times, times new roman, serif";
		 htmlDoc[i].style.fontSize = "105%";
		 htmlDoc[i].style.fontWeight = "normal";
		 }
		 flag = false;
		}
		else
		{
		 ...
		 for (var i = 0; i < htmlDoc.length; i++)
		 {
		 htmlDoc[i].style.fontFamily = "verdana, geneva, helvetica, sans-serif"; 
		 htmlDoc[i].style.fontSize = "90%";
